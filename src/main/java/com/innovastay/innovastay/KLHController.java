...
public class KLHController {
    ...
    public void bookHotel(ActionEvent event) {
        ...
        showPaymentOptions("Limketkai Luxe Hotel");
    }
    ...
    private void showCardPayment(String hotelName) {
        try {
            ...
            ButtonType payButton = new ButtonType("Pay ₱4,161", ButtonBar.ButtonData.OK_DONE);
            ...
            dialog.showAndWait().ifPresent(success -> {
                if (success) {
                    ...
                    navigateToConfirmation(hotelName, "₱4,161", "Credit Card", getLastFour(cardNumber.getText()));
                }
            });
    ...
    private void showGCashPayment(String hotelName) {
        try {
            ...
            String ref = "KLH" + (System.currentTimeMillis() % 10000);

            details.getChildren().addAll(
                    createDetail("Amount:", "₱4,161"),
            ...
            dialog.showAndWait().ifPresent(success -> {
                if (success) {
                    ...
                    // Navigate to confirmation page
                    navigateToConfirmation(hotelName, "₱4,161", "GCash", ref);
                }
            });
    ...
    public void initialize() {
        System.out.println("=== KLH CONTROLLER INITIALIZED ===");
    }
}