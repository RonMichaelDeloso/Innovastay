...
public class CVHController {
    ...
    public void bookHotel(ActionEvent event) {
        ...
        showPaymentOptions("Country Village Hotel");
    }
    ...
    private void showCardPayment(String hotelName) {
        try {
            ...
            ButtonType payButton = new ButtonType("Pay ₱1,502", ButtonBar.ButtonData.OK_DONE);
            ...
            dialog.showAndWait().ifPresent(success -> {
                if (success) {
                    ...
                    navigateToConfirmation(hotelName, "₱1,502", "Credit Card", getLastFour(cardNumber.getText()));
                }
            });
    ...
    private void showGCashPayment(String hotelName) {
        try {
            ...
            String ref = "CVH" + (System.currentTimeMillis() % 10000);

            details.getChildren().addAll(
                    createDetail("Amount:", "₱1,502"),
            ...
            dialog.showAndWait().ifPresent(success -> {
                if (success) {
                    ...
                    // Navigate to confirmation page
                    navigateToConfirmation(hotelName, "₱1,502", "GCash", ref);
                }
            });
    ...
    public void initialize() {
        System.out.println("=== CVH CONTROLLER INITIALIZED ===");
    }
}